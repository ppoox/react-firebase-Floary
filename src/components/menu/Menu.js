      ...
      <AppBar className={classes.appBar}>
        <Toolbar>
          ...
          <Typography component="h1" variant="display1" color="inherit" noWrap className={classes.title}>
            <Link to="/BoardList" className={classes.LogoCss}>Floary</Link>
          </Typography>
              ...
              >
                <Paper>
                  <ClickAwayListener onClickAway={this.handlePeopleClose}>
                    <MenuList>
                      <MenuItem onClick={this.handlePeopleClose}><Link to="/UserProfile" className={classes.linkCss} >Profile</Link></MenuItem>
